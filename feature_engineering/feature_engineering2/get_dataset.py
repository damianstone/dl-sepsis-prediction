...
def run_full_pipeline():
    ...
    split_balanced_dataset_maintain_ratio(input_file="after_feature_engineering.parquet")#or input_file="after_feature_engineering.parquet" for non-vectorization
