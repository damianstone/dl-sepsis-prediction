from balanced_data import split_balanced_dataset_maintain_ratio
...
def run_full_pipeline():
    ...
    split_balanced_dataset_maintain_ratio(
        input_file="XGBoost/after_feature_engineering.parquet"
    )
    print("Train/test split done\n")

    print("Step 5: SHAP analysis on engineered training set")
    run_shap_on_data(
        parquet_file="XGBoost/after_feature_engineering.parquet",
        output_tag="engineered",
    )
