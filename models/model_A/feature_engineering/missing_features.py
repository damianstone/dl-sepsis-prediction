...
def run_missing_feature_pipeline(input_file="balanced_dataset.parquet",output_file="features_with_missing_interval.parquet"):
    root = find_project_root()
    input_path = root / "dataset" /  "XGBoost" / "feature_engineering" /input_file
